...
$config = Swagger\Client\Configuration::getDefaultConfiguration()->setApiKey('Apikey', '61d4c043-c8a6-4772-97ee-8cd86f7f030b');
...
$image_file = "uploads/text1.png"; // \SplFileObject | Image file to perform OCR on.  Common file formats such as PNG, JPEG are supported.
